"""Add users, sessions, audit_logs (Phase 1 — Authentication).
...
# CREATE TABLE doesn't also try to (and fail with DuplicateObjectError).
user_role_enum = postgresql.ENUM(
    "ADMIN", "DEVELOPER", "RESEARCHER", "VIEWER", name="user_role", create_type=False
)
